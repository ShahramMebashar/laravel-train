...
Vue.component('example-component', __webpack_require__(/*! ./components/ExampleComponent.vue */ "./resources/js/components/ExampleComponent.vue")["default"]); //Vue.component('post-comment', require('./components/PostComment.vue').default);

Vue.component('post-comment', function () {
  return __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ./components/PostComment */ "./resources/js/components/PostComment.vue"));
});
Vue.use(_saeris_vue_spinners__WEBPACK_IMPORTED_MODULE_1__["VueSpinners"]);
var app = new Vue({
  el: '#app',
...
window.axios.defaults.headers.common['X-CSRF-TOKEN'] = document.querySelector('[name="csrf-token"]').getAttribute('content'); // import Echo from 'laravel-echo';
...
/* harmony import */ var _modules_comment_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/comment/index */ "./resources/js/store/modules/comment/index.js");
...
var store = new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  modules: {
    Comment: _modules_comment_index__WEBPACK_IMPORTED_MODULE_2__["default"]
  }
});
...
/***/ "./resources/js/store/modules/comment/index.js":
/*!*****************************************************!*\
  !*** ./resources/js/store/modules/comment/index.js ***!
  \*****************************************************/
/*! exports provided: default */
...
var mutations = {
  ...
  addComment: function addComment(state, comment) {
    state.comments = [comment].concat(_toConsumableArray(state.comments));
  }
};
var actions = {
  fetchComments: function fetchComments(_ref, url) {
  ...
  addComment: function addComment(_ref4, _ref5) {
    var commit = _ref4.commit;
    var postId = _ref5.postId,
        body = _ref5.body;
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/posts/" + postId + "/comments", {
      body: body
    }).then(function (resp) {
